...
public class DoctorOwnScheduleResponse {
    ...
    public DoctorOwnScheduleResponse(String id, String doctorUsername, String doctorName, String title, String department, String date,
